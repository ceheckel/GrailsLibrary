...
class BookController {
    ...
    static final boolean debugCover = true
    ...
    def showCover() {
        ...
        if(book == null) {
            def coverError = "Cover cannot be shown, book " + params.id + " was not found"
            response.outputStream << coverError
            response.outputStream.flush()
        } else {
            // output the cover's byte array and flush the output
